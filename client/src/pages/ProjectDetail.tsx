...
const ProjectDetail = () => {
  ...
  const { data: project, isLoading, error } = useQuery<Project>({
    ...
    enabled: Number.isInteger(projectId) && Number(projectId) > 0,
  });
            ...
            <div>
              <div className="bg-background p-6 rounded-xl">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech, index) => (
                      <span key={index} className="px-2 py-1 bg-muted text-foreground rounded text-xs font-mono">
                        {tech}
                      </span>
                    ))}
                  </div>
                ...
                <div className="flex flex-col space-y-2 mt-6">
                  {project.link && <Button asChild className="w-full">
                    <a 
                      href={project.link}
                      target="_blank" 
